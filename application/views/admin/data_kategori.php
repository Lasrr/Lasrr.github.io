        ...
        <div class="card-body">
          ...
          <form class="row g-3 needs-validation" action="<?= base_url();?>admin/act_tambahkategori " method="post" novalidate>
            <div class="col-12">
              ...
              <?= form_error('nama_kategori', '<smal class="text-danger pl-3">', '</small>');?>
            </div>
            ...
            foreach ($data_kategori as $k){
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?= $k->id_kategori;?>"><i class="bi bi-pencil-square"></i></a>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <?php echo form_open_multipart(base_url('admin/edit_kategori/'.$k->id_kategori));?>
