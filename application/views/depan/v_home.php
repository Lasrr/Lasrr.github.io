...
<body>
  ...
  <header id="header" class="fixed-top ">
    ...
    <a href="https://instagram.com/absor.20" class="logo"><img src="template/assets/img/smk.png" alt="" class="img-fluid"> Perpustakaan Digital </a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="<?php echo base_url(); ?>auth/login_admin"
              class="btn-get-started scrollto">Login Admin</a></li>
        </ul>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Aplikasi Perpustakaan Digital<br>Lasr</br></h1>
          <h2>Kami adalah tim desainer berbakat yang membuat situs web Lasr</h2>
          <div><a href="<?php echo base_url(); ?>auth/login_anggota" class="btn-get-started scrollto">Login Anggota</a>
            <a href="<?= base_url(); ?>auth/regristrasi" class="btn-get-started scrollto">Regristired Anggota</a>
          </div>
        </div>
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="<?php echo base_url(); ?>template/assets/img/perpus.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="col-lg-3 col-md-6 footer-contact">
          ...
          <p>
            ...
            <strong>Phone:</strong> 085600752603<br>
            <strong>Email:</strong> cahqdus20012007@gmail.com<br><br>
          </p>
        </div>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Lasr</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
            ...
            Designed by <a href="https://www.instagram.com/absor.20/">LasrMade</a>
          </div>
        </div>
        <div class="social-links text-center text-md-right pt-3 pt-md-0">
          <a href="https://twitter.com/ULILABS83756547" class="twitter"><i class="bx bxl-twitter"></i></a>
          <a href="https://www.facebook.com/profile.php?id=100028373297675&mibextid=sCpJLy" class="facebook"><i
              class="bx bxl-facebook"></i></a>
          <a href="https://instagram.com/absor.20" class="instagram"><i class="bx bxl-instagram"></i></a>
